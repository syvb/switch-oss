...
#if PLATFORM(WKC)
    WEBCORE_EXPORT JSC::JSValue executeScriptIgnoringException(const String& script, bool forceUserGesture = false, Node* thisObject = nullptr);
    WEBCORE_EXPORT JSC::JSValue executeScriptInWorldIgnoringException(DOMWrapperWorld&, const String& script, bool forceUserGesture = false, Node* thisObject = nullptr);
    WEBCORE_EXPORT JSC::JSValue executeUserAgentScriptInWorldIgnoringException(DOMWrapperWorld&, const String& script, bool forceUserGesture, Node* thisObject = nullptr);
    WEBCORE_EXPORT ValueOrException executeUserAgentScriptInWorld(DOMWrapperWorld&, const String& script, bool forceUserGesture, Node* thisObject = nullptr);
    WEBCORE_EXPORT void executeAsynchronousUserAgentScriptInWorld(DOMWrapperWorld&, RunJavaScriptParameters&&, ResolveFunction&&, Node* thisObject = nullptr);
    ValueOrException evaluateInWorld(const ScriptSourceCode&, DOMWrapperWorld&, Node* thisObject = nullptr);
#else
...
#if PLATFORM(WKC)
    WEBCORE_EXPORT JSC::JSValue jsValueForNode(DOMWrapperWorld&, Node&);
#endif
...
private:
#if PLATFORM(WKC)
    ValueOrException executeUserAgentScriptInWorldInternal(DOMWrapperWorld&, RunJavaScriptParameters&&, Node* thisObject = nullptr);
    ValueOrException executeScriptInWorld(DOMWrapperWorld&, RunJavaScriptParameters&&, Node* thisObject = nullptr);
    ValueOrException callInWorld(RunJavaScriptParameters&&, DOMWrapperWorld&, Node* thisObject = nullptr);
#else
