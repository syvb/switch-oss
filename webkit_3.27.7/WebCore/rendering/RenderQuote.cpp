...
#else
    WKC_DEFINE_STATIC_BOOL(didOneTimeCheck, false);
#endif
    if (!didOneTimeCheck) {
...
#else
    WKC_DEFINE_STATIC_TYPE(StringImpl*, quotationMarkString, stringForQuoteCharacter(quotationMark));
#endif
...
#else
    WKC_DEFINE_STATIC_TYPE(StringImpl*, apostropheString, stringForQuoteCharacter(apostrophe));
#endif
