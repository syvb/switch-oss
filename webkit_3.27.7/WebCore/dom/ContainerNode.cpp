...
#else
WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(ChildNodesLazySnapshot*, ChildNodesLazySnapshot, latestSnapshot);
#endif

#if !PLATFORM(WKC)
unsigned ScriptDisallowedScope::s_count = 0;
#else
WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(unsigned, ScriptDisallowedScope, s_count);
#endif
#if ASSERT_ENABLED
#if !PLATFORM(WKC)
ScriptDisallowedScope::EventAllowedScope* ScriptDisallowedScope::EventAllowedScope::s_currentScope = nullptr;
#else
WKC_DEFINE_GLOBAL_CLASS_OBJ(ScriptDisallowedScope::EventAllowedScope*, ScriptDisallowedScope::EventAllowedScope, s_currentScope, nullptr);
#endif
#endif
