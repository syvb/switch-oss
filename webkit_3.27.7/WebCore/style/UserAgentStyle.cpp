...
#endif
#else
WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(RuleSet*, UserAgentStyle, defaultStyle);
WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(RuleSet*, UserAgentStyle, defaultQuirksStyle);
WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(RuleSet*, UserAgentStyle, defaultPrintStyle);
WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(unsigned, UserAgentStyle, defaultStyleVersion);

WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(StyleSheetContents*, UserAgentStyle, defaultStyleSheet);
WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(StyleSheetContents*, UserAgentStyle, quirksStyleSheet);
WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(StyleSheetContents*, UserAgentStyle, dialogStyleSheet);
WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(StyleSheetContents*, UserAgentStyle, svgStyleSheet);
WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(StyleSheetContents*, UserAgentStyle, mathMLStyleSheet);
WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(StyleSheetContents*, UserAgentStyle, mediaControlsStyleSheet);
WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(StyleSheetContents*, UserAgentStyle, fullscreenStyleSheet);
WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(StyleSheetContents*, UserAgentStyle, plugInsStyleSheet);
#if ENABLE(SERVICE_CONTROLS)
WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(StyleSheetContents*, UserAgentStyle, imageControlsStyleSheet);
#endif
WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(StyleSheetContents*, UserAgentStyle, mediaQueryStyleSheet);
#if ENABLE(DATALIST_ELEMENT)
WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(StyleSheetContents*, UserAgentStyle, dataListStyleSheet);
#endif
#if ENABLE(INPUT_TYPE_COLOR)
WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(StyleSheetContents*, UserAgentStyle, colorInputStyleSheet);
#endif
#endif
...
#if PLATFORM(WKC)
    if (staticScreenEval.isNull())
        staticScreenEval.construct(String(MAKE_STATIC_STRING_IMPL("screen")));
#endif
...
#if PLATFORM(WKC)
    if (staticPrintEval.isNull())
        staticPrintEval.construct(String(MAKE_STATIC_STRING_IMPL("print")));
#endif
