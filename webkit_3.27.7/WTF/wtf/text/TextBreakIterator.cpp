...
#else
    WKC_DEFINE_STATIC_TYPE(UBreakIterator*, staticWordBreakIterator, initializeIterator(UBRK_WORD));
#endif
...
#else
    WKC_DEFINE_STATIC_TYPE(UBreakIterator*, staticSentenceBreakIterator, initializeIterator(UBRK_SENTENCE));
#endif
...
#else
WKC_DEFINE_GLOBAL_TYPE(std::atomic<UBreakIterator*>, nonSharedCharacterBreakIterator, ATOMIC_VAR_INIT(nullptr));
#endif
