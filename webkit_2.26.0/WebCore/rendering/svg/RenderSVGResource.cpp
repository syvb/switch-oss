...
#else
    WKC_DEFINE_STATIC_TYPE(RenderSVGResourceSolidColor*, s_sharedSolidPaintingResource, 0);
#endif
...
static inline void removeFromCacheAndInvalidateDependencies(RenderElement& renderer, bool needsLayout, WeakHashSet<RenderObject>* visitedRenderers)
{
...
#if PLATFORM(WKC)
            if (invalidatingDependencies.isNull())
                invalidatingDependencies.construct();
#endif
