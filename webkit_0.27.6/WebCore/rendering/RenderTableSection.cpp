...
#if PLATFORM(WKC)
template<> inline std::pair<WebCore::RenderTableCell**, ptrdiff_t>
std::get_temporary_buffer<WebCore::RenderTableCell*>(ptrdiff_t count) _NOEXCEPT
{
    WebCore::RenderTableCell** p = (WebCore::RenderTableCell**)WTF::fastMalloc(sizeof(WebCore::RenderTableCell*) * count);
    return (std::pair<WebCore::RenderTableCell**, ptrdiff_t>(p, count));
}
template<> inline void
std::return_temporary_buffer<WebCore::RenderTableCell*>(WebCore::RenderTableCell** buf) _NOEXCEPT
{
    WTF::fastFree(buf);
}
#endif
