...
#if PLATFORM(WKC)
    void getNodeCompositeRect(LayoutRect* rects, bool isOverflowXHidden, bool isOverflowYHidden, int tx = 0, int ty = 0) const;
    LayoutRect absoluteCompositeTransformedRectInternal(bool clip, bool fastPath) const;
    LayoutRect absoluteCompositeTransformedRect(bool ignoreBorder, bool clip, bool fastPath) const;
