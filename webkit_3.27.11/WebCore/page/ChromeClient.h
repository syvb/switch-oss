...
public:
...
#if PLATFORM(WKC)
        ViewportConstrainedPositionTrigger = 1 << 28,
    ...
    virtual void dispatchMetaInitialAutofocusDidChange(const String&) const { };
    virtual void dispatchApplyOverflowToViewport(Frame& frame, bool overflowXHidden, bool overflowYHidden) const { };
    virtual bool dispatchWillSetHasFocusVisibleForFocusedElement(Element& focusedElement, bool value) const { return value; };
#endif
