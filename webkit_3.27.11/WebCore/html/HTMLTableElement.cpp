...
#else
            WKC_DEFINE_STATIC_TYPE(StyleProperties*, solidBorderStyle, leakBorderStyle(CSSValueHidden));
#endif
...
#else
        WKC_DEFINE_STATIC_TYPE(StyleProperties*, solidBorderStyle, leakBorderStyle(CSSValueSolid));
#endif
        return solidBorderStyle;
    }
#if !PLATFORM(WKC)
...
#else
    WKC_DEFINE_STATIC_TYPE(StyleProperties*, outsetBorderStyle, leakBorderStyle(CSSValueOutset));
#endif
...
#else
        WKC_DEFINE_STATIC_TYPE(StyleProperties*, rowBorderStyle, leakGroupBorderStyle(true));
#endif
...
#else
    WKC_DEFINE_STATIC_TYPE(StyleProperties*, columnBorderStyle, leakGroupBorderStyle(false));
#endif
