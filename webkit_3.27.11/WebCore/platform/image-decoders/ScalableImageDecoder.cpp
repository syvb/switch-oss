...
#if PLATFORM(WKC)
void ScalableImageDecoder::clearFrameBufferCacheExcludeFrame(size_t excludeFrame)
{
...
void ScalableImageDecoder::clearFrameBufferCache()
{
...
void ScalableImageDecoder::retryDecodeSize()
{
