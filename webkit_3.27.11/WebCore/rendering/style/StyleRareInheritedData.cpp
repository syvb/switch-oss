...
#if ENABLE(CSS_IMAGE_RESOLUTION)
#if PLATFORM(WKC)
    , imageResolutionSource(static_cast<unsigned>(RenderStyle::initialImageResolutionSource()))
    , imageResolutionSnap(static_cast<unsigned>(RenderStyle::initialImageResolutionSnap()))
#else
