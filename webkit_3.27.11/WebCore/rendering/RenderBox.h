...
#if PLATFORM(WKC)
    void addFocusRingRects(Vector<LayoutRect>&, const LayoutPoint& additionalOffset, const RenderLayerModelObject* paintContainer = nullptr, bool useTransform = true) override;
#else
...
#else
    WKC_DEFINE_GLOBAL_CLASS_OBJ_ENTRY_ZERO(bool, s_hadNonVisibleOverflow);
#endif
};
