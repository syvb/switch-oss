...
#if PLATFORM(WKC)
    void focusRingRects(Vector<LayoutRect>&);
#endif
...
#if PLATFORM(WKC)
    virtual void addFocusRingRects(Vector<LayoutRect>&, const LayoutPoint& /* additionalOffset */, const RenderLayerModelObject* /* paintContainer */ = nullptr, bool /* useTransform */ = true) { };
#else
