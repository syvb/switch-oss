...
#if PLATFORM(WKC)
    void addFocusRingRects(Vector<LayoutRect>&, const LayoutPoint& additionalOffset, const RenderLayerModelObject* paintContainer = 0, bool useTransform = true) final;
#else
