...
#else
    WKC_DEFINE_GLOBAL_CLASS_OBJ_ENTRY_ZERO(unsigned, s_widgetHierarchyUpdateSuspendCount);
    WKC_DEFINE_GLOBAL_CLASS_OBJ_ENTRY_ZERO(bool, s_haveScheduledWidgetToMove);
#endif
};
