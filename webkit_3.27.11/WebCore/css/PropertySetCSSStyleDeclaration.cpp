...
#else
    WKC_DEFINE_GLOBAL_CLASS_OBJ_ENTRY_ZERO(unsigned, s_scopeCount);
    WKC_DEFINE_GLOBAL_CLASS_OBJ_ENTRY_ZERO(PropertySetCSSStyleDeclaration*, s_currentDecl);
    WKC_DEFINE_GLOBAL_CLASS_OBJ_ENTRY_ZERO(bool, s_shouldNotifyInspector);
    WKC_DEFINE_GLOBAL_CLASS_OBJ_ENTRY_ZERO(bool, s_shouldDeliver);
#endif
...
#else
WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(unsigned, StyleAttributeMutationScope, s_scopeCount);
WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(PropertySetCSSStyleDeclaration*, StyleAttributeMutationScope, s_currentDecl);
WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(bool, StyleAttributeMutationScope, s_shouldNotifyInspector);
WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(bool, StyleAttributeMutationScope, s_shouldDeliver);
#endif
