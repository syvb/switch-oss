...
#define CSS_MEDIAQUERY_NINTENDO_SWITCH_DEVICE_MODE(macro) macro(nintendoSwitchDeviceMode, "-webkit-nintendo-switch-device-mode")
#else
#define CSS_MEDIAQUERY_NINTENDO_SWITCH_DEVICE_MODE(macro)
#endif

#if ENABLE(WKC_PERFORMANCE_MODE_CSS_MEDIA)
#define CSS_MEDIAQUERY_NINTENDO_SWITCH_PERFORMANCE_MODE(macro) macro(nintendoSwitchPerformanceMode, "-webkit-nintendo-switch-performance-mode")
#else
