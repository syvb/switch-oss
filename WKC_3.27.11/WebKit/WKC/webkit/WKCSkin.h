...
enum SkinColor {
    ...
    /** @brief ActiveText color */
    ESkinColorActiveText,
    ...
    /** @brief Canvas color */
    ESkinColorCanvas,
    /** @brief CanvasText color */
    ESkinColorCanvasText,
    /** @brief CaptionText color */
    ESkinColorCaptionText,
    /** @brief Field color */
    ESkinColorField,
    /** @brief FieldText color */
    ESkinColorFieldText,
    ...
    /** @brief VisitedText color */
    ESkinColorVisitedText,
    /** @brief Window color */
    ESkinColorWindow,
...
struct WKCSkin_ {
    ...
    /**
       @brief Array of structures used to store skin image data for dark mode
       @details
       Array is the size of WKC::ESkinImages.
     */
    WKCSkinImage fDarkImages[ESkinImages];
    /**
    ...
    */
    ...
    /**
       @brief Array of structures used to store skin colors for dark mode
       @details
       Array is the size of WKC::ESkinColors.
    */
    unsigned int fDarkColors[ESkinColors];
    /**
