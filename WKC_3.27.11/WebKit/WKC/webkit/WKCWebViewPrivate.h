...
public:
    ...
    void notifyRelayout();
    void notifyPaintOffscreenFrom(const WebCore::IntRect& rect, const WKCFloatPoint& p);
    ...
    void setSizeForCSSDefaultViewportUnits(const WebCore::FloatSize& size);
    void setSizeForCSSSmallViewportUnits(const WebCore::FloatSize& size);
    void setSizeForCSSLargeViewportUnits(const WebCore::FloatSize& size);
    void setLayoutViewportOverrideRect(const WebCore::LayoutRect& rect);
