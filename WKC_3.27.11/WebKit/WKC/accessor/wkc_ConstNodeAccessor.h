...
class ConstEventTargetAccessor
{
public:

    ConstEventTargetAccessor( const WebCore::EventTarget* obj )
     : m_webcore( obj )
    {}
...
protected:
    const void* m_webcore;
};


class ConstNodeAccessor : public ConstEventTargetAccessor
{
public:
    enum NodeType
    {
    ...
    ConstNodeAccessor( const WebCore::Node* obj )
     : ConstEventTargetAccessor( reinterpret_cast<const WebCore::EventTarget*>( obj ) )
    {}

    const WebCore::Node* ptr() const { return static_cast<const WebCore::Node*>( m_webcore ); }

    WebCore::ContainerNode* parent() const;
