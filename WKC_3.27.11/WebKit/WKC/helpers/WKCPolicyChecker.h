...
#ifndef _WKC_HELPER_WKCPOLICYCHECKER_H_
#define _WKC_HELPER_WKCPOLICYCHECKER_H_
...
protected:
    ...
    PolicyChecker(PolicyCheckerPrivate&);
    ~PolicyChecker();
...
private:
    ...
    PolicyCheckerPrivate& m_private;
};
} // namespace

#endif // _WKC_HELPER_WKCPOLICYCHECKER_H_
