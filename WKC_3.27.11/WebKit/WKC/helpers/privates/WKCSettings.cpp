...
{
    m_standardFontFamily = PARENT()->standardFontFamily();
...
{
    m_fixedFontFamily = PARENT()->fixedFontFamily();
...
{
    m_serifFontFamily = PARENT()->serifFontFamily();
...
{
    m_sansSerifFontFamily = PARENT()->sansSerifFontFamily();
...
{
    m_cursiveFontFamily = PARENT()->cursiveFontFamily();
...
{
    m_fantasyFontFamily = PARENT()->fantasyFontFamily();
...
void WKCSettings::setLogsPageMessagesToSystemConsoleEnabled(bool arg)
{
    PARENT()->setLogsPageMessagesToSystemConsoleEnabled(arg);
}

bool WKCSettings::logsPageMessagesToSystemConsoleEnabled() const
{
    return PARENT()->logsPageMessagesToSystemConsoleEnabled();
}
...
void WKCSettings::setForcedPrefersContrastAccessibilityValue(ForcedAccessibilityValue value)
{
    PARENT()->setForcedPrefersContrastAccessibilityValue(toWebCoreForcedAccessibilityValue(value));
}

WKC::ForcedAccessibilityValue WKCSettings::forcedPrefersContrastAccessibilityValue() const
{
    return toWKCForcedAccessibilityValue(PARENT()->forcedPrefersContrastAccessibilityValue());
}
