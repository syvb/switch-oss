...
public:
    ...
    virtual WebCore::Page* createWindow(WebCore::Frame&, const WebCore::WindowFeatures&, const WebCore::NavigationAction&) override final;
    ...
    virtual void dispatchApplyOverflowToViewport(WebCore::Frame&, bool overflowXHidden, bool overflowYHidden) const override final;
    virtual bool dispatchWillSetHasFocusVisibleForFocusedElement(WebCore::Element& focusedElement, bool value) const override final;
    ...
    virtual void scrollContainingScrollViewsToRevealRect(const WebCore::IntRect&) const override final;
    ...
    virtual void print(WebCore::Frame&, const WebCore::StringWithDirection&) override final;
    ...
    virtual void elementDidFocus(WebCore::Element&, const WebCore::FocusOptions&) override final;
    virtual void elementDidBlur(WebCore::Element&) override final;
    virtual void elementDidRefocus(WebCore::Element&, const WebCore::FocusOptions&) override final;
    ...
    virtual WebCore::DisplayRefreshMonitorFactory* displayRefreshMonitorFactory() const override final;
    ...
    virtual void triggerRenderingUpdate() override final;
    ...
    virtual void exitVideoFullscreenForVideoElement(WebCore::HTMLVideoElement&, WTF::CompletionHandler<void(bool)>&& completionHandler) override final;
    ...
    virtual void requestCookieConsent(CompletionHandler<void(WebCore::CookieConsentDecisionResult)>&&) override final;
    virtual void classifyModalContainerControls(Vector<WTF::String>&& texts, CompletionHandler<void(Vector<WebCore::ModalContainerControlType>&&)>&&) override final;
    virtual void decidePolicyForModalContainer(OptionSet<WebCore::ModalContainerControlType>, CompletionHandler<void(WebCore::ModalContainerDecision)>&&) override final;
...
private:
    ...
    virtual bool hoverSupportedByPrimaryPointingDevice() const override final;
    virtual bool hoverSupportedByAnyAvailablePointingDevice() const override final;
    virtual std::optional<WebCore::PointerCharacteristics> pointerCharacteristicsOfPrimaryPointingDevice() const override final;
    virtual OptionSet<WebCore::PointerCharacteristics> pointerCharacteristicsOfAllAvailablePointingDevices() const override final;
    virtual void setTextIndicator(const WebCore::TextIndicatorData&) const override final;
};
