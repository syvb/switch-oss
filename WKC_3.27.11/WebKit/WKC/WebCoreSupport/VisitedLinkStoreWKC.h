...
public:
    static WTF::Ref<VisitedLinkStoreWKC> create(WKCWebViewPrivate*);
    virtual ~VisitedLinkStoreWKC() override;

    virtual bool isLinkVisited(WebCore::Page&, WebCore::SharedStringHash, const URL& baseURL, const WTF::AtomString& attributeURL) override;
...
private:
    ...
    WTF::Vector<WebCore::SharedStringHash> m_links;
};
