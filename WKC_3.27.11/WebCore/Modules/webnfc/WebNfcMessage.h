...
public:
    ...
    static Ref<WebNfcMessage> create(String&, Vector<String>&, WebNfcMessageDataType);
    static Ref<WebNfcMessage> create(String&, Vector<RefPtr<DOMURL> >&);
    static Ref<WebNfcMessage> create(String&, Vector<Vector<char> >&, Vector<String>&);
