...
Ref<WebNfcMessage> WebNfcMessage::create(String& scope, Vector<String>& datas, WebNfcMessageDataType dataType)
{
    return adoptRef(*new WebNfcMessage(scope, datas, dataType));
}

Ref<WebNfcMessage> WebNfcMessage::create(String& scope, Vector<RefPtr<DOMURL> >& datas)
{
    return adoptRef(*new WebNfcMessage(scope, datas));
}

Ref<WebNfcMessage> WebNfcMessage::create(String& scope, Vector<Vector<char> >& datas, Vector<String>& contentTypes)
{
