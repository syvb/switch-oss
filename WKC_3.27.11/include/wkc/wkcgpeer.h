...
*/
WKC_PEER_API float wkcFontGetTextWidthPeer(void* in_font, int in_flags, const U16Char* in_str, int in_strlen, float* out_clip_width);
/**
...
*/
WKC_PEER_API float wkcFontDrawTextPeer(void* in_font, int in_flags, const U16Char* in_str, int in_strlen,
                                 void* in_offscreen, const WKCSize* in_offscreensize,
                                 int in_rowbytes, int in_fmt,
                                 const WKCFloatRect* in_textbox, const WKCFloatRect* in_clip,
...
WKC_PEER_API bool wkcFontGetGlyphsForCharactersPeer(void* in_font, const U16Char* in_str, int in_strlen, unsigned short* out_glyphs);

WKC_PEER_API bool wkcFontGetKerningPeer(void* in_font, U16Char in_char_1, U16Char in_char_2, int* out_x, int* out_y);
...
enum {
    ...
    WKC_SKINCOLOR_CANVAS,
    WKC_SKINCOLOR_CANVASTEXT,
    WKC_SKINCOLOR_CAPTIONTEXT,
    WKC_SKINCOLOR_FIELD,
    WKC_SKINCOLOR_FIELDTEXT,
...
struct wkcSkin_ {
    ...
    /** @brief Array of structures for storing dark skin image data */
    wkcSkinImage fDarkImages[WKC_IMAGE_MAX_NUM];
    ...
    /** @brief Array for storing dark color information for each color identifier */
    unsigned int fDarkColors[WKC_SKINCOLOR_MAX_NUM];
...
@param in_use_dark_appearance Use dark appearance or not
...
*/
WKC_PEER_API const unsigned char* wkcStockImageGetBitmapPeer(int in_image_id, bool in_use_dark_appearance = false);
/**
...
For information about types, see the section "UI Implementation - Skin" in \"NetFront Browser NX $(NETFRONT_NX_VERSION) WKC Browser/RSS API Reference\".
*/
WKC_PEER_API unsigned int wkcStockImageGetSkinColorPeer(int in_color_id, bool in_use_dark_appearance = false);
/**
...
enum {
    WKC_VERTICAL_ORIENTATION_PROPERTY_U = 0,
    WKC_VERTICAL_ORIENTATION_PROPERTY_R,
    WKC_VERTICAL_ORIENTATION_PROPERTY_TU,
    WKC_VERTICAL_ORIENTATION_PROPERTY_TR,
};
...
WKC_PEER_API void wkcDrawContextDrawTextPeer(void* in_context, const U16Char* in_str, int in_len, const WKCFloatRect* in_textbox, const WKCFloatRect* in_clip, WKCPeerFont* in_font, int in_flag);
...
WKC_PEER_API int wkcDrawContextIsEmojiSequencePeer(const U16Char* in_str, int in_len);
WKC_PEER_API float wkcDrawContextGetEmojiWidthPeer(void* in_font, const U16Char* in_str, int in_len, float* out_clipwidth);
WKC_PEER_API void wkcDrawContextClearEmojiCachePeer(void);

WKC_PEER_API int wkcDrawContextGetVerticalOrientationPropertyPeer(const UniChar32 in_char);
