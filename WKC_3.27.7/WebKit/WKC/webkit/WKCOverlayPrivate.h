...
public:
    static WTF::Ref<WKCOverlayInternal> create(WKCWebViewPrivate*, WKCOverlayIf*);
...
private:
    ...
    WTF::RefPtr<WebCore::GraphicsLayer> m_layer;
    int m_zOrder;
...
public:
    static Ref<WKCOverlayList> create(WKCWebViewPrivate*);
