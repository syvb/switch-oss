...
public:
    ...
    virtual RefPtr<WebCore::HistoryItem> itemAtIndex(int) override;
    virtual unsigned backListCount() const override;
    virtual unsigned forwardListCount() const override;
