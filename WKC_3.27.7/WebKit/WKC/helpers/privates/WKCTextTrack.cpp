...
{
    WebCore::TextTrack::Kind kind = m_webcore->kind();
    switch (kind) {
    case WebCore::TextTrack::Kind::Subtitles:
        return String("subtitles");
    case WebCore::TextTrack::Kind::Captions:
        return String("captions");
    case WebCore::TextTrack::Kind::Descriptions:
        return String("descriptions");
    case WebCore::TextTrack::Kind::Chapters:
        return String("chapters");
    case WebCore::TextTrack::Kind::Metadata:
        return String("metadata");
    case WebCore::TextTrack::Kind::Forced:
