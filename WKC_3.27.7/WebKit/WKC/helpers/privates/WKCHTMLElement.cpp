...
#include "helpers/privates/WKCHTMLObjectElementPrivate.h"
#include "helpers/privates/WKCHTMLLabelElementPrivate.h"
...
HTMLElementPrivate::create(WebCore::HTMLElement* parent)
{
    ...
    } else if (parent->hasTagName(WebCore::HTMLNames::objectTag)) {
        return new HTMLObjectElementPrivate(static_cast<WebCore::HTMLObjectElement*>(parent));
    ...
    } else if (parent->hasTagName(WebCore::HTMLNames::labelTag)) {
        return new HTMLLabelElementPrivate(static_cast<WebCore::HTMLLabelElement*>(parent));
