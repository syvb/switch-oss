...
class PolicyCheckerPrivate {
    WTF_MAKE_FAST_ALLOCATED;
public:
    PolicyCheckerPrivate(WebCore::FrameLoader::PolicyChecker*);
    ~PolicyCheckerPrivate();

    WebCore::FrameLoader::PolicyChecker* webcore() const { return m_webcore; }
    PolicyChecker& wkc() { return m_wkc; }

    FrameLoadType loadType() const;

private:
    WebCore::FrameLoader::PolicyChecker* m_webcore;
