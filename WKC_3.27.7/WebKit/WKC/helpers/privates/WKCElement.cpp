...
ElementPrivate::focus(bool restorePreviousSelection)
{
    ...
    options.selectionRestorationMode = restorePreviousSelection ? WebCore::SelectionRestorationMode::RestoreOrSelectAll : WebCore::SelectionRestorationMode::SelectAll;
    webcore()->focus(options);
}
...
bool
ElementPrivate::hasFocusVisible() const
{
    return webcore()->hasFocusVisible();
}

void
ElementPrivate::setHasFocusVisible(bool value)
{
    WebCore::Style::PseudoClassChangeInvalidation focusVisibleStyleInvalidation(*webcore(), WebCore::CSSSelector::PseudoClassFocusVisible, value);
    webcore()->setHasFocusVisible(value);
}

void
ElementPrivate::invalidateStyle()
{
    webcore()->invalidateStyle();
}
...
bool
Element::hasFocusVisible() const
{
    return static_cast<ElementPrivate&>(priv()).hasFocusVisible();

}

void
Element::setHasFocusVisible(bool value)
{
    static_cast<ElementPrivate&>(priv()).setHasFocusVisible(value);
}

void
Element::invalidateStyle()
{
    static_cast<ElementPrivate&>(priv()).invalidateStyle();
}
