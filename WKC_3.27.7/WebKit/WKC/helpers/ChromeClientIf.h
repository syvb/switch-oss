...
public:
    ...
    */
    ...
    /**
       ...
       @endcond
    */
    virtual WKC::Page* createWindow(WKC::Frame*, const WKC::WindowFeatures&) = 0;
    /**
       @cond WKC_PRIVATE_DOCUMENT
    ...
    */
    ...
    /**
       @cond WKC_PRIVATE_DOCUMENT
       @brief Gives initial-autofocus change notification
       @param string Value of the content attribute
       @return None
       @endcond
    */
    virtual void dispatchMetaInitialAutofocusDidChange(const WKC::String&) = 0;
    ...
    /**
       ...
       @endcond
    */
    virtual void dispatchApplyOverflowToViewport(WKC::Frame*, bool overflowXHidden, bool overflowYHidden) = 0;

    virtual bool dispatchWillSetHasFocusVisibleForFocusedElement(WKC::Element& focusedElement, bool value) = 0;
    ...
    */
    ...
    /**
       ...
       @endcond
    */
    virtual void scrollContainingScrollViewsToRevealRect(const WKCRect&) const = 0;
    ...
    */
    ...
    virtual void elementDidFocus(const WKC::Element*, const WKC::FocusOptions&) = 0;
    virtual void elementDidBlur(const WKC::Element*) = 0;
    virtual void elementDidRefocus(const WKC::Element*, const WKC::FocusOptions&) = 0;
    ...
    */
    ...
    virtual void attachViewOverlayGraphicsLayer(WKC::GraphicsLayer*) = 0;
    ...
    enum CompositingTrigger {
        ...
        ViewportConstrainedPositionTrigger = 1 << 28, // belows are WKC Original
        WillChangeTrigger = 1 << 29,
