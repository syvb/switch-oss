...
/**
@brief Gets integer file descriptor
@retval Reference to wkcFileFilenoProc()
@details
Calls the callback function, WKCFileProcs::fFilenoProc, set by wkcFileCallbackSetPeer().
*/
WKC_PEER_API int        wkcFileFilenoPeer(void* in_fd);
/**
