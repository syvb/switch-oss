...
#if PLATFORM(WKC)
template<> inline std::pair<WebCore::StyleRulePage**, ptrdiff_t>
std::get_temporary_buffer<WebCore::StyleRulePage*>(ptrdiff_t count) _NOEXCEPT
{
    WebCore::StyleRulePage** p = (WebCore::StyleRulePage**)WTF::fastMalloc(sizeof(WebCore::StyleRulePage*) * count);
    return (std::pair<WebCore::StyleRulePage**, ptrdiff_t>(p, count));
}
template<> inline void
std::return_temporary_buffer<WebCore::StyleRulePage*>(WebCore::StyleRulePage** buf) _NOEXCEPT
{
    WTF::fastFree(buf);
}
#endif
