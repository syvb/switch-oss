...
extern void wkcResetVariables_cairo_image_compositor_c(void);
extern void wkcResetVariables_cairo_misc_c(void);
extern void wkcResetVariables_cairo_scale_font_c(void);
extern void wkcResetVariables_cairo_toy_font_face_c(void);
extern void wkcResetVariables_cairo_image_source_c(void);
extern void wkcResetVariables_cairo_recording_surface_c(void);

cairo_public void
cairo_resetVariables(void)
{
    wkcResetVariables_cairo_image_compositor_c();
    wkcResetVariables_cairo_misc_c();
    wkcResetVariables_cairo_scale_font_c();
    wkcResetVariables_cairo_toy_font_face_c();
    wkcResetVariables_cairo_image_source_c();
    wkcResetVariables_cairo_recording_surface_c();
}
#endif
