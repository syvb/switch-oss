 ...
 * Copyright (c) 2016-2025 ACCESS CO., LTD. All rights reserved.
 *
...
#else
static Vector<WTF::Function<void ()>>& postResolutionCallbackQueue()
{
    WKC_DEFINE_STATIC_PTR(Vector<WTF::Function<void ()>>*, vector, 0);
    if (!vector)
        vector = new Vector<WTF::Function<void ()>>();
    return *vector;
}
#endif
...
#else
void queuePostResolutionCallback(WTF::Function<void ()> callback)
{
