...
#else
    WKC_DEFINE_STATIC_HASHMAPPTR(AtomicString, AutofillCategory, map, 0);
    if (!map)
        map = new HashMap<AtomicString, AutofillCategory>();
    if (map->isEmpty()) {
        map->add(AtomicString("off", AtomicString::ConstructFromLiteral), AutofillCategory::Off);
        map->add(AtomicString("on", AtomicString::ConstructFromLiteral), AutofillCategory::Automatic);

        map->add(AtomicString("name", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("honorific-prefix", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("given-name", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("additional-name", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("family-name", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("honorific-suffix", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("nickname", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("username", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("new-password", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("current-password", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("organization-title", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("organization", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("street-address", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("address-line1", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("address-line2", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("address-line3", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("address-level4", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("address-level3", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("address-level2", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("address-level1", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("country", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("country-name", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("postal-code", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("cc-name", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("cc-given-name", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("cc-additional-name", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("cc-family-name", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("cc-number", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("cc-exp", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("cc-exp-month", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("cc-exp-year", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("cc-csc", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("cc-type", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("transaction-currency", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("transaction-amount", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("language", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("bday", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("bday-day", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("bday-month", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("bday-year", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("sex", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("url", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);
        map->add(AtomicString("photo", AtomicString::ConstructFromLiteral), AutofillCategory::Normal);

        map->add(AtomicString("tel", AtomicString::ConstructFromLiteral), AutofillCategory::Contact);
        map->add(AtomicString("tel-country-code", AtomicString::ConstructFromLiteral), AutofillCategory::Contact);
        map->add(AtomicString("tel-national", AtomicString::ConstructFromLiteral), AutofillCategory::Contact);
        map->add(AtomicString("tel-area-code", AtomicString::ConstructFromLiteral), AutofillCategory::Contact);
        map->add(AtomicString("tel-local", AtomicString::ConstructFromLiteral), AutofillCategory::Contact);
        map->add(AtomicString("tel-local-prefix", AtomicString::ConstructFromLiteral), AutofillCategory::Contact);
        map->add(AtomicString("tel-local-suffix", AtomicString::ConstructFromLiteral), AutofillCategory::Contact);
        map->add(AtomicString("tel-extension", AtomicString::ConstructFromLiteral), AutofillCategory::Contact);
        map->add(AtomicString("email", AtomicString::ConstructFromLiteral), AutofillCategory::Contact);
        map->add(AtomicString("impp", AtomicString::ConstructFromLiteral), AutofillCategory::Contact);
    }
